...
_update({
    ...
    0xA18C: 0xA18C,  # 数字阴框码0（■ + 0）
    0xA18D: 0xA18D,  # 数字阴框码1（■ + 1）
    0xA18E: 0xA18E,  # 数字阴框码2（■ + 2）
    0xA18F: 0xA18F,  # 数字阴框码3（■ + 3）
    0xA190: 0xA190,  # 数字阴框码4（■ + 4）
    0xA191: 0xA191,  # 数字阴框码5（■ + 5）
    0xA192: 0xA192,  # 数字阴框码6（■ + 6）
    0xA193: 0xA193,  # 数字阴框码7（■ + 7）
    0xA194: 0xA194,  # 数字阴框码8（■ + 8）
    0xA195: 0xA195,  # 数字阴框码9（■ + 9）
    0xA196: 0x1F6AD,  # 🚭
    0xA197: 0x1F377,  # 🍷
    0xA198: 0x26A0,  # ⚠
    0xA199: 0x2620,  # ☠
